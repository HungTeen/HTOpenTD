 ...
 **/
public record AttackGoalSetting(int duration, int coolDown, int startTick, boolean needRest, double distance, Optional<Holder<SoundEvent>> attackSound,
                                Holder<IEffectComponent> effect) {
    public static final Codec<AttackGoalSetting> CODEC = RecordCodecBuilder.<AttackGoalSetting>mapCodec(instance -> instance.group(
            ...
            OTDEffectComponents.getCodec().fieldOf("effect").forGetter(AttackGoalSetting::effect)

 ...
 */
public record LaserGoalSetting(int coolDown, int duration, int effectInterval, Holder<ITargetFilter> laserFilter, Holder<IEffectComponent> continueEffect, Holder<IEffectComponent> finalEffect, float laserWidth, double trackDistance, double laserDistance, boolean needRest, Optional<ResourceLocation> laserTexture) {
    ...
    public static final Codec<LaserGoalSetting> CODEC = RecordCodecBuilder.<LaserGoalSetting>mapCodec(instance -> instance.group(
            ...
            OTDTargetFilters.getCodec().fieldOf("laser_filter").forGetter(LaserGoalSetting::laserFilter),
            OTDEffectComponents.getCodec().fieldOf("continue_effect").forGetter(LaserGoalSetting::continueEffect),
            OTDEffectComponents.getCodec().fieldOf("final_effect").forGetter(LaserGoalSetting::finalEffect),

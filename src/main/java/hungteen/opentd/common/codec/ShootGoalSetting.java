 ...
 **/
public record ShootGoalSetting(int duration, int coolDown, int startTick, int shootCount, boolean needRest, boolean mustSeeTarget, Optional<SoundEvent> shootSound,

 ...
 **/
public record ConstantAffectSetting(int cd, Holder<ITargetFinder> targetFinder, Holder<IEffectComponent> effect) {
    ...
    public static final Codec<ConstantAffectSetting> CODEC = RecordCodecBuilder.<ConstantAffectSetting>mapCodec(instance -> instance.group(
            ...
            OTDEffectComponents.getCodec().fieldOf("effect").forGetter(ConstantAffectSetting::effect)

 ...
 **/
public record TowerSetting(boolean canRideInWater, boolean customDeath, boolean persistent, int deathDuration) {

    public static final TowerSetting DEFAULT = new TowerSetting(false, false, false, 0);

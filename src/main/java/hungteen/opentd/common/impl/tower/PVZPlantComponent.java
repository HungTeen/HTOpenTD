...
public record PVZPlantComponent(PlantSettings plantSetting, List<TargetSetting> targetSettings,
    ...
    public record PlantSettings(CompoundTag extraNBT, GrowSettings growSetting, ResourceLocation id, int maxExistTick, boolean changeDirection, boolean pushable, RenderSetting renderSetting) {
        ...
        public static final Codec<PlantSettings> CODEC = RecordCodecBuilder.<PlantSettings>mapCodec(instance -> instance.group(
                ...
                RenderSetting.CODEC.fieldOf("render_setting").forGetter(PlantSettings::renderSetting)
    ...
    public record BulletSettings(ITargetFilter targetFilter, IEffectComponent effect, float bulletSpeed,
                                 ...
                                 boolean lockToTarget, RenderSetting renderSettings, Optional<ParticleSetting> hitParticle, Optional<ParticleSetting> trailParticle) {
        ...
        public static final Codec<BulletSettings> CODEC = RecordCodecBuilder.<BulletSettings>mapCodec(instance -> instance.group(
                ...
                RenderSetting.CODEC.fieldOf("render_setting").forGetter(BulletSettings::renderSettings),

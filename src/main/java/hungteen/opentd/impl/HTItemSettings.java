...
public class HTItemSettings {
    ...
    public static final HTRegistryHolder<ItemSettings> DEFAULT = SUMMON_ITEMS.innerRegister(OpenTD.prefix("default"), new ItemSettings(64, 0, new ArrayList<>(), new ArrayList<>()));

    public record ItemSettings(int maxStackSize, int maxDamage, List<String> textComponents, List<ISummonRequirement> requirements) {
